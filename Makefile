.PHONY: setup format lint run-app dev-up dev-down prod-up prod-down offline-up offline-down config-help config-generate config-validate config-summary config-env config-docker config-services
